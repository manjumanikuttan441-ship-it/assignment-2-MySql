...
create table location (location_id int primary key auto_increment,location varchar(50));
create table employees( employee_id int primary key,employee_name varchar(100),
gender char(1),age int,hire_date date,
designation varchar(100),department_id int,location_id int, salary int);
